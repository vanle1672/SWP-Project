...
public class DoctorDao {
    ...
    public boolean createDoctor(String name, String email, String password, String degree, int experience, int speciality_id, String image, String phone, String dob, boolean gender, String address) {
        ...
        try {
            this.connection = ContactDB.makeConnection();//thiết lập kết nối đến cơ sở dữ liệu bằng cách gọi phương thức makeConnection() từ lớp ContactDB.
            preparedStatement = connection.prepareStatement(sql);//Dòng preparedStatement = connection.prepareStatement(sql); tạo một đối tượng PreparedStatement từ kết nối connection và câu truy vấn SQL sql.
