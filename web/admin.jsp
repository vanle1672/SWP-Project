<%-- 
    Document   : admin
    Created on : May 29, 2023, 6:11:55 PM
    Author     : Habee
--%>
...
<head>
    <link rel="stylesheet" href="assets/css/admincss/style.css">
    <link rel="stylesheet" href="assets/css/admincss/util.css">
    <link rel="stylesheet" href="assets/css/admincss/main.css">
    <meta charset="UTF-8">
...
<body onload="time()">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="about.html" data-toggle="tooltip" data-placement="bottom"
                            title="Tổng">Tổng</a></li>
                    <li><a href="admin-benhnhan" data-toggle="tooltip" data-placement="bottom" title="Bệnh Nhân">Bệnh Nhân</a></li>
                    <li><a href="admin-bacsi" data-toggle="tooltip" data-placement="bottom" title="Bác Sĩ">Bác Sĩ</a></li>
    ...
    <div class="container-fluid al">
        <div id="clock"></div>
        <Br>
        <p class="timkiemnhanvien"><b>TÌM KIẾM :</b></p><Br><Br>
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Nhập tên Bệnh nhân cần tìm...">
        ...
        <button class="nv btn add-new" type="button" data-toggle="tooltip" data-placement="top"
            title="Thêm Bệnh Nhân"><i class="fas fa-user-plus"></i></button>
...
<!--        <button class="nv cog" data-toggle="tooltip" data-placement="bottom" title=""><i
        ...
        <table class="table table-bordered" id="myTable">
            <thead>
                <tr class="ex">
                    <th width="auto">Tên Bệnh Nhân</th>
