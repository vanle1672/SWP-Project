    ...
    <body onload="time()">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="" data-toggle="tooltip" data-placement="bottom" title="Bệnh Nhân">Bệnh Nhân</a></li>
        ...
        <div class="container-fluid al">
            ...
            <button class="nv btn add-new" type="button" data-toggle="tooltip" data-placement="top"
                    title="Thêm Bác sĩ"><i class="fas fa-user-plus"></i></button>
...
<!--            <button class="nv cog" data-toggle="tooltip" data-placement="bottom" title=""><i
            ...
            <table class="table table-bordered" id="myTable">
                <thead>
                    <tr class="ex">
                        <th>Ten</th>
                        <th width="auto">Chuyên Khoa</th>
                        <th width="auto">Bằng Cấp</th>
                        <th>Kinh Nghiệm</th>
                ...
                <tbody>
                    ...
                    <c:if test="${sessionScope.acc.isDoctor == 1}">

                    </c:if>
                    <c:forEach items="${listbacsi}" var="i">
                        <tr>



                            <td>"${sessionScope.acc.isAdmin}"</td>
                            <td>"${i.specialization}"</td>
                            <td>"${i.degree}"</td>
                            <td>"${i.experience}" năm</td>
                            <td>"${i.image}"</td>
