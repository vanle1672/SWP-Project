    ...
    <form action="${pageContext.request.contextPath}/doctor-change-pass" method="post">
        <div class="p-3 py-5">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <!-- : Nếu biến status có giá trị "error", hiển thị một đoạn văn bản màu đỏ (class text-danger) được lấy từ biến message. -->
                <!<!-- Nếu biến status có giá trị "success", hiển thị một đoạn văn bản màu xanh (class text-success) được lấy từ biến message. -->
